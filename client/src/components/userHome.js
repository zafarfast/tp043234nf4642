  ...
  return (
    <>
      ...
      <div id="generated-image-container">
        ...
        <p id="user-thought-preview">
          Having coffee with my dog on a sunny morning. He is looking at me like
          my bestie{" "}
        </p>
      ...
      <div id="thoughts-chain">
        <UserPost
          src={findUsers[0]?.image}
          thoughtText={findUsers[0]?.thought}
          userProfilePic="./images/user-profile-pic.jpg"
        />
        <UserPost
          src={findUsers[1]?.image}
          thoughtText={findUsers[1]?.thought}
          userProfilePic="./images/user-profile-pic.jpg"
        />
        <UserPost
          src={findUsers[2]?.image}
          thoughtText={findUsers[2]?.thought}
          userProfilePic="./images/user-profile-pic.jpg"
        />
        <UserPost
          src={findUsers[0]?.image}
